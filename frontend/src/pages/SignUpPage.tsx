      ...
      <div className="card-body">
        ...
        <div className="w-full max-w-md mx-auto">
          <label className="input input-bordered flex items-center gap-2 my-3">
            ...
            <input type="text" className="grow" placeholder="电子邮箱" value={email} onChange={(e) => setEmail(e.target.value)} />
          </label>
          <label className="input input-bordered flex items-center gap-2 my-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <input type="text" className="grow" placeholder="用户名（至少 6 个字符）" value={username} onChange={(e) => setUsername(e.target.value)} />
          </label>
          <label className="input input-bordered flex items-center gap-2 my-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <input type="password" className="grow" placeholder="密码（至少 6 个字符）" value={password} onChange={(e) => setPassword(e.target.value)} />
          </label>
        </div>
